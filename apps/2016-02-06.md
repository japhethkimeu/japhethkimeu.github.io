...
This tool was developed to support decision-making for the Restore Africa Project by enabling partners and stakeholders identify suitable sites for agroforestry, silvopastoral/rangeland management, and assisted natural regeneration (FMNR) interventions across project areas in East and Southern Africa. By integrating multiple datasets — including land cover, land use, conservation zones, and deforestation trends — the tool provides a comprehensive assessment of site suitability, restoration potential, and intervention prioritization.

It allows users to generate actionable outputs that inform planning, collaboration, funding, and implementation. These outputs include:
